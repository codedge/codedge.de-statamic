...
post_content:
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' of this setup by now, let''s leave it with what advocates usually say: It depends! :wink: To get a general feeling have look at the costs section at the end of this article. A lot of the (further) costs depend on the pricing.'
  -
    type: paragraph
    content:
      -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' is not going to be used in our AWS deployment. For orchestration of the containers we are going to use Amazons ECS tasks definition in which you can link containers. I will come to that a bit later when talking about the task definition.'
  -
    type: paragraph
    content:
      -
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: ' is the name you are going to choose in Amazon ECS.'
              -
                type: hard_break
              -
                type: text
              ...
              -
                type: text
                text: ' is the name for the service that picks up the task and deploys it into the cluster. '
      -
        type: list_item
        content:
          -
        ...
        content:
          -
            ...
            content:
              ...
              -
                type: text
                text: '. I''ll come to this in the section about configuring AWS Fargate and its roles.'
      -
        type: list_item
        content:
          -
  ...
  -
    ...
    content:
      ...
      -
        type: text
        text: ' has no rights to execute any operation on ECR or ECS. In our case, this user need to be able to push images to ECR or to run services on ECS to execute our task to spin up the container. For that we need to attach to two policies to our group:'
  -
    type: bullet_list
    content:
      -
        ...
        content:
          -
            ...
            content:
              -
                type: text
                text: 'AmazonSSMReadOnlyAccess: we are going to need that to read our environment variables from AWS Systems Manager Parameter Store'
  -
    type: set
    attrs:
      values:
